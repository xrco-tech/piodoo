...
const TYPE_CFG = {
    ...
    ImageCarousel:      { icon: "🎠", label: "Carousel",   color: "#b45309", bg: "#fffbeb", border: "#fcd34d" },
    ...
    ChipsSelector:      { icon: "🧩", label: "Chips",       color: "#0891b2", bg: "#ecfeff", border: "#67e8f9" },
    NavigationList:     { icon: "📋", label: "Nav List",    color: "#1a73e8", bg: "#e8f0fe", border: "#93c5fd" },
